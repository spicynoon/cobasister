      ...
      <div className="py-6  bg-ash max-w-[550px] rounded-xl px-5 md:px-20 md:mx-0 mx-7">
        <div className=" text-white">
          <div className="flex flex-col justify-center items-center ">
            <h1 className="text-2xl md:text-4xl font-bold md:pb-1">
              Equilibrium
            </h1>
            ...
            <form onSubmit={handleRegister} className="flex flex-col gap-y-2">
              ...
              <div className="text-xs flex flex-col gap-y-2">
                <p>
                  Sudah punya akun?{' '}
                  <span>
                    <Link className="text-equ-blue" to="/login">
                      Masuk
                    </Link>
                  </span>
                </p>
              ...
              <div className="flex flex-col justify-center text-xs items-center ">
                ...
                <Button
                  type="submit"
                  className="px-16 py-6 rounded-full bg-blue-700 hover:bg-blue-600 max-w-[100px] font-bold"
                >
                  Daftar
                </Button>
              </div>
