                ...
                <div className=" text-white">
                    ...
                    <div>
                        <form action="" className="flex flex-col gap-y-2">
                            ...
                            <Input className="rounded-full bg-white border-2 h-[45px] text-black ps-6" type="email" placeholder="Email" />
                            <Input className="rounded-full bg-white border-2 h-[45px] text-black ps-6" type="password" placeholder="Password" />
                        </form>
